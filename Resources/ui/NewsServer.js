...
var eventLabelWidth;
var newsLabelWidth;
var pressReleaseLabelWidth;
var gapBetweenLabels;
...
exports.newsPannel = function(e) {
    ...
    InfluncerViewDataFetch = function(response) {
        ...
        for (var i = 0; i < Category.length; i++) {
            dataForCategory[i] = Ti.UI.createPickerRow({
                title : Category[i],
                color : '#756789'
            });

        };
        dataForCategory[j] = Ti.UI.createPickerRow({
            title : 'All',
            color : '#756789'
        });
    ...
    win.addEventListener('postlayout', function(e) {
        ...
        /********Start************* News, Event and Press Release lables marging adjustment ****************************/
        
        screenWidth = win.rect.width;
        Ti.API.info("screenWidth::******"+screenWidth);
        newsLabelWidth = leftToolbarBtn.rect.width; 
        Ti.API.info("newsLabelWidth::******"+newsLabelWidth);
        Ti.API.info("leftToolbarBtn Stringify::******"+JSON.stringify(leftToolbarBtn));
        
        
        /********End************* News, Event and Press Release lables marging adjustment ****************************/
